...
- Effect plugins import `@poltter-ai/plugin/v2/effect`, not `@poltter-ai/core`.
- Public domain values use generated `@poltter-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@poltter-ai/plugin/v2/effect`.
