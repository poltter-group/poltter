...
import { EventManifest } from "@poltter-ai/schema/event-manifest"
import { Location } from "@poltter-ai/schema/location"
import type { Definition } from "@poltter-ai/schema/event"
...
export const PoltterEvent = event.schema
export type PoltterEvent = typeof PoltterEvent.Type
export type PoltterEventEncoded = typeof PoltterEvent.Encoded
