import { base64Encode } from "@poltter-ai/core/util/encode"
import { Event } from "@poltter-ai/schema/event"
import { SessionStatusEvent } from "@poltter-ai/schema/session-status-event"
import { SessionV1 } from "@poltter-ai/schema/session-v1"
import type {
  AssistantMessage,
  GlobalEvent,
  Message,
...
import { mockPoltterServer } from "../../utils/mock-server"
import { installSseTransport } from "../../utils/sse-transport"
import { expectSessionTitle } from "../../utils/waits"

export const directory = "C:/Poltter/TimelineStability"
...
export const model = { providerID: "poltter", modelID: "claude-opus-4-6", variant: "max" }
...
export async function setupTimeline(
  ...
  if (input.locale) {
    await page.addInitScript((locale) => {
      localStorage.setItem("poltter.global.dat:language", JSON.stringify({ locale }))
    }, input.locale)
  }
...
function provider() {
  return {
    ...
    connected: ["poltter"],
    default: { providerID: "poltter", modelID: "claude-opus-4-6" },
  }
}
