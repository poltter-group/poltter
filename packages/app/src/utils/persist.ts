...
const GLOBAL_STORAGE = "poltter.global.dat"
const WINDOW_STORAGE = "poltter.window"
const LOCAL_PREFIX = "poltter."
...
function workspaceStorage(dir: string) {
  ...
  return `poltter.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `poltter.draft.${head}.${sum}.dat`
}
