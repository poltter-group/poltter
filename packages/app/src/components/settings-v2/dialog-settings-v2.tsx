...
import { Dialog } from "@poltter-ai/ui/v2/dialog-v2"
import { TabsV2 } from "@poltter-ai/ui/v2/tabs-v2"
...
import { SettingsUpgradeV2 } from "./upgrade"
    ...
    <Dialog size="x-large" variant="settings" class="settings-v2-dialog">
      ...
      >
        <TabsV2.List>
          <div class="flex flex-col justify-between h-full w-full">
            <div class="flex flex-col gap-3 w-full">
              <button type="button" class="settings-v2-nav-back" onClick={() => dialog.close()} aria-label={language.t("common.back")}>
              ...
              <div class="flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-1.5">
                  ...
                  <div class="flex flex-col gap-1.5 w-full">
                    <TabsV2.Trigger value="upgrade">
                      <Icon name="arrow-up" />
                      {language.t("settings.upgrade.title")}
                    </TabsV2.Trigger>
                  </div>
                </div>
              </div>
        ...
        <TabsV2.Content value="integrations" class="settings-v2-panel">
          <SettingsIntegrations directory={directory} />
        </TabsV2.Content>
        ...
        <TabsV2.Content value="upgrade" class="settings-v2-panel">
          <SettingsUpgradeV2 />
        </TabsV2.Content>
      </TabsV2>
    </Dialog>
