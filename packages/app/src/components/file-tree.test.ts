...
beforeAll(async () => {
  ...
  mock.module("@poltter-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@poltter-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@poltter-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@poltter-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
