...
import { Icon } from "@poltter-ai/ui/v2/icon"
...
import { useTheme } from "@poltter-ai/ui/theme"
...
const featuredProviders = ["poltter", "poltter-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "poltter" && (!item.cost || item.cost.input === 0)
