import type { PoltterEvent, SessionMessageInfo, SessionPendingMessage } from "@poltter-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: PoltterEvent): V2SessionReduction | undefined => {
