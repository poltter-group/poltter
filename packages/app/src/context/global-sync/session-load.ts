import type { SessionApi } from "@poltter-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { PoltterClient } from "@poltter-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: PoltterClient; directory: string; limit: number }) {
  try {
