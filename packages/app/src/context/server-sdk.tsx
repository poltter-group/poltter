import type { PoltterEvent } from "@poltter-ai/client/promise"
import type { Event } from "@poltter-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: PoltterEvent }
...
export function adaptServerEvent(event: PoltterEvent): ServerEvent {
...
function currentDelta(event: PoltterEvent | undefined): CurrentDelta | undefined {
  if (
