...
import poltterLogo from "@/assets/poltter-logo.png"
    ...
    <div class="@container relative flex flex-col min-h-0 h-full flex-1">
      ...
      >
        <div class="absolute inset-0 flex flex-col items-center justify-center">
          <div class="flex-1" />
          <img src={poltterLogo} alt="Poltter" class="h-auto w-full max-w-[600px] select-none object-contain" />
          <div class="flex-1" />
        </div>
        <div class="absolute inset-x-0 bottom-0 flex justify-center px-6 pb-6">
