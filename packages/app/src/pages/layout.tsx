...
import { Session } from "@poltter-ai/sdk/v2/client"
...
import { retry } from "@poltter-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@poltter-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://poltter.ai/desktop-feedback")}
      renderPanel={() =>
