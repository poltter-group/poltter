import type { FilePart, Project, UserMessage, VcsFileDiff } from "@poltter-ai/sdk/v2"
import { getFilename } from "@poltter-ai/core/util/path"
...
import type { SessionReviewLineComment } from "@poltter-ai/session-ui/session-review"
import { ResizeHandle } from "@poltter-ai/ui/resize-handle"
import { Select } from "@poltter-ai/ui/select"
import { SelectV2 } from "@poltter-ai/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@poltter-ai/ui/scroll-view"
import { Tabs } from "@poltter-ai/ui/tabs"
import { ButtonV2 } from "@poltter-ai/ui/v2/button-v2"
import { createAutoScroll } from "@poltter-ai/ui/hooks"
import { previewSelectedLines } from "@poltter-ai/session-ui/pierre/selection-bridge"
import { Button } from "@poltter-ai/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@poltter-ai/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@poltter-ai/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@poltter-ai/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@poltter-ai/session-ui/v2/session-review-v2"
