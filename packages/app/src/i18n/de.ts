...
export const dict = {
  ...
  "dialog.provider.poltter.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.poltter.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.poltterGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Poltter",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Poltter zu nutzen.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Poltter zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Poltter zu nutzen.",
  ...
  "dialog.plugins.empty": "In poltter.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Poltter-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingPoltter": "Poltter wird geprüft...",
  "wsl.onboarding.checkingPoltterIn": "Poltter in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingPoltter": "Poltter wird aktualisiert...",
  "wsl.onboarding.updatingPoltterIn": "Poltter in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updatePoltterIn": "Aktualisieren Sie Poltter in {{distro}}.",
  "wsl.onboarding.updatePoltter": "Poltter aktualisieren",
  "wsl.onboarding.poltterReadyIn": "Poltter ist in {{distro}} bereit.",
  "wsl.onboarding.poltterReady": "Poltter ist bereit.",
  "wsl.onboarding.installPoltterIn": "Installieren Sie Poltter in {{distro}}.",
  "wsl.onboarding.installPoltter": "Poltter installieren",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Poltter einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Poltter konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Poltter erneut.",
  ...
  "toast.update.description": "Eine neue Version von Poltter ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Poltter-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (poltter.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Poltter unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Poltter enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Poltter-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Poltter ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Poltter auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Poltter dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Poltter anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Poltter automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Poltter.",
