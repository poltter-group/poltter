export const dict = {
  ...
  "dialog.provider.poltter.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.poltter.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.poltterGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Poltter",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.poltterZen.visit.prefix": "Odwiedź ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Poltter.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w poltter.json",
  ...
  "dialog.server.description": "Przełącz serwer Poltter, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingPoltter": "Sprawdzanie Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Sprawdzanie Poltter w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Aktualizowanie Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Aktualizowanie Poltter w dystrybucji {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Zaktualizuj Poltter w dystrybucji {{distro}}.",
  "wsl.onboarding.updatePoltter": "Zaktualizuj Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter jest gotowy.",
  "wsl.onboarding.installPoltterIn": "Zainstaluj Poltter w dystrybucji {{distro}}.",
  "wsl.onboarding.installPoltter": "Zainstaluj Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Poltter będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Poltter nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Poltter.",
  ...
  "toast.update.description": "Nowa wersja Poltter ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Poltter",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (poltter.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Poltter nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Poltter zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Poltter wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Poltter",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Poltter na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Poltter ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Poltter.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Poltter",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Poltter.",
