...
export const dict = {
  ...
  "dialog.provider.poltter.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.poltter.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.poltterGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Poltter tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Poltter'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.poltterZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Poltter'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Poltter'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler poltter.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Poltter sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingPoltter": "Poltter kontrol ediliyor...",
  "wsl.onboarding.checkingPoltterIn": "{{distro}} içinde Poltter kontrol ediliyor...",
  "wsl.onboarding.updatingPoltter": "Poltter güncelleniyor...",
  "wsl.onboarding.updatingPoltterIn": "{{distro}} içinde Poltter güncelleniyor...",
  "wsl.onboarding.updatePoltterIn": "{{distro}} içindeki Poltter'u güncelleyin.",
  "wsl.onboarding.updatePoltter": "Poltter'u güncelle",
  "wsl.onboarding.poltterReadyIn": "{{distro}} içinde Poltter hazır.",
  "wsl.onboarding.poltterReady": "Poltter hazır.",
  "wsl.onboarding.installPoltterIn": "Poltter'u {{distro}} içine kurun.",
  "wsl.onboarding.installPoltter": "Poltter'u kur",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Poltter'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Poltter bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Poltter'u tekrar açın.",
  ...
  "toast.update.description": "Poltter'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Poltter ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (poltter.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Poltter henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Poltter ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Poltter Masaüstü",
  ...
  "settings.desktop.wsl.description": "Poltter sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Poltter'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Poltter'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Poltter'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Poltter'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Poltter başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Poltter'un en son sürümünü kullanıyorsunuz.",
