...
export const dict = {
  ...
  "dialog.provider.poltter.note": "使用 Poltter Zen 或 API 密钥连接",
  "dialog.provider.poltter.tagline": "可靠的优化模型",
  "dialog.provider.poltterGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Poltter 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Poltter 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Poltter 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Poltter 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 poltter.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Poltter 服务器。",
  ...
  "wsl.onboarding.checkingPoltter": "正在检查 Poltter...",
  "wsl.onboarding.checkingPoltterIn": "正在检查 {{distro}} 中的 Poltter...",
  ...
  "wsl.onboarding.poltterReadyIn": "{{distro}} 中的 Poltter 已就绪。",
  "wsl.onboarding.poltterReady": "Poltter 已就绪。",
  "wsl.onboarding.installPoltterIn": "在 {{distro}} 中安装 Poltter。",
  "wsl.onboarding.installPoltter": "安装 Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "未安装 Poltter",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Poltter 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Poltter 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Poltter。",
  ...
  "toast.update.description": "Poltter 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Poltter 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (poltter.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Poltter 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Poltter 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Poltter 服务器。",
  ...
  "settings.general.row.language.description": "更改 Poltter 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Poltter 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Poltter 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Poltter 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Poltter 启动时自动检查更新",
