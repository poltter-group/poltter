export const dict = {
  ...
  "dialog.provider.poltter.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.poltter.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.poltterGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Poltter",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "يمنحك Poltter Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.poltterZen.visit.prefix": "قم بزيارة ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Poltter.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في poltter.json",
  ...
  "dialog.server.description": "تبديل خادم Poltter الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingPoltter": "جارٍ التحقق من Poltter...",
  "wsl.onboarding.checkingPoltterIn": "جارٍ التحقق من Poltter في {{distro}}...",
  "wsl.onboarding.updatingPoltter": "جارٍ تحديث Poltter...",
  "wsl.onboarding.updatingPoltterIn": "جارٍ تحديث Poltter في {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "حدّث Poltter في {{distro}}.",
  "wsl.onboarding.updatePoltter": "تحديث Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter جاهز في {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter جاهز.",
  "wsl.onboarding.installPoltterIn": "ثبّت Poltter في {{distro}}.",
  "wsl.onboarding.installPoltter": "تثبيت Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Poltter من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Poltter التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Poltter.",
  ...
  "toast.update.description": "نسخة جديدة من Poltter ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Poltter",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (poltter.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Poltter لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Poltter نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Poltter داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Poltter",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Poltter على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Poltter يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Poltter.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Poltter",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Poltter.",
