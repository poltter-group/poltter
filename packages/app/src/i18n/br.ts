export const dict = {
  ...
  "dialog.provider.poltter.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.poltter.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.poltterGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Poltter",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Poltter.",
  ...
  "dialog.plugins.empty": "Plugins configurados em poltter.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Poltter este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingPoltter": "Verificando o Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Verificando o Poltter em {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Atualizando o Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Atualizando o Poltter em {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Atualize o Poltter em {{distro}}.",
  "wsl.onboarding.updatePoltter": "Atualizar o Poltter",
  "wsl.onboarding.poltterReadyIn": "O Poltter está pronto em {{distro}}.",
  "wsl.onboarding.poltterReady": "O Poltter está pronto.",
  "wsl.onboarding.installPoltterIn": "Instale o Poltter em {{distro}}.",
  "wsl.onboarding.installPoltter": "Instalar o Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Poltter possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Poltter não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Poltter novamente.",
  ...
  "toast.update.description": "Uma nova versão do Poltter ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Poltter",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (poltter.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Poltter ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Poltter inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Poltter dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Poltter",
  ...
  "settings.general.row.appearance.description": "Personalize como o Poltter aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Poltter segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Poltter é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Poltter iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Poltter.",
