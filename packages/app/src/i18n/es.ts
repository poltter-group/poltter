export const dict = {
  ...
  "dialog.provider.poltter.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.poltter.tagline": "Modelos optimizados y fiables",
  "dialog.provider.poltterGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Poltter",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.poltterZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.poltterZen.visit.prefix": "Visita ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Poltter.",
  ...
  "dialog.plugins.empty": "Plugins configurados en poltter.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Poltter se conecta esta app.",
  ...
  "wsl.onboarding.checkingPoltter": "Comprobando Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Comprobando Poltter en {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Actualizando Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Actualizando Poltter en {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Actualiza Poltter en {{distro}}.",
  "wsl.onboarding.updatePoltter": "Actualizar Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter está listo en {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter está listo.",
  "wsl.onboarding.installPoltterIn": "Instala Poltter en {{distro}}.",
  "wsl.onboarding.installPoltter": "Instalar Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Poltter pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Poltter no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Poltter.",
  ...
  "toast.update.description": "Una nueva versión de Poltter ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Poltter",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (poltter.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Poltter no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Poltter incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Poltter dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Poltter",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Poltter en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Poltter sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Poltter.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Poltter",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Poltter.",
