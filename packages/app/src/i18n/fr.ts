export const dict = {
  ...
  "dialog.provider.poltter.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.poltter.tagline": "Modèles optimisés et fiables",
  "dialog.provider.poltterGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Poltter",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.poltterZen.visit.prefix": "Visitez ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Poltter.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans poltter.json",
  ...
  "dialog.server.description": "Changez le serveur Poltter auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingPoltter": "Vérification d'Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Vérification d'Poltter dans {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Mise à jour d'Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Mise à jour d'Poltter dans {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Mettez à jour Poltter dans {{distro}}.",
  "wsl.onboarding.updatePoltter": "Mettre à jour Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter est prêt dans {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter est prêt.",
  "wsl.onboarding.installPoltterIn": "Installez Poltter dans {{distro}}.",
  "wsl.onboarding.installPoltter": "Installer Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Poltter puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Poltter n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Poltter.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Poltter ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Poltter",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (poltter.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Poltter ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Poltter inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Poltter dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Poltter",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Poltter sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Poltter suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Poltter.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Poltter",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Poltter.",
