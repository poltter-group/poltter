export const dict = {
  ...
  "dialog.provider.poltter.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.poltter.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.poltterGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Poltter",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.poltterZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.poltterZen.visit.prefix": "Besøg ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Poltter.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i poltter.json",
  ...
  "dialog.server.description": "Skift hvilken Poltter-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingPoltter": "Tjekker Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Tjekker Poltter i {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Opdaterer Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Opdaterer Poltter i {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Opdater Poltter i {{distro}}.",
  "wsl.onboarding.updatePoltter": "Opdater Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter er klar i {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter er klar.",
  "wsl.onboarding.installPoltterIn": "Installer Poltter i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Poltter kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Poltter kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Poltter igen.",
  ...
  "toast.update.description": "En ny version af Poltter ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Poltter-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (poltter.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Poltter understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Poltter inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Poltter-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Poltter",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Poltter ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Poltter følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Poltter er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Poltter starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Poltter.",
