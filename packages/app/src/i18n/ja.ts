export const dict = {
  ...
  "dialog.provider.poltter.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.poltter.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.poltterGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Poltterが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Poltterで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してPoltterで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Poltterで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "poltter.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するPoltterサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingPoltter": "Poltterを確認中...",
  "wsl.onboarding.checkingPoltterIn": "{{distro}}内のPoltterを確認中...",
  "wsl.onboarding.updatingPoltter": "Poltterを更新中...",
  "wsl.onboarding.updatingPoltterIn": "{{distro}}内のPoltterを更新中...",
  "wsl.onboarding.updatePoltterIn": "{{distro}}内のPoltterを更新してください。",
  "wsl.onboarding.updatePoltter": "Poltterを更新",
  "wsl.onboarding.poltterReadyIn": "{{distro}}内のPoltterの準備ができました。",
  "wsl.onboarding.poltterReady": "Poltterの準備ができました。",
  "wsl.onboarding.installPoltterIn": "{{distro}}にPoltterをインストールしてください。",
  "wsl.onboarding.installPoltter": "Poltterをインストール",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltterがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "PoltterでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Poltterをもう一度開いてください。",
  ...
  "toast.update.description": "Poltterの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをPoltterチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (poltter.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: PoltterはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Poltterには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でPoltterサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Poltterの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのPoltterの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Poltterがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Poltterのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Poltter の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Poltter は最新バージョンです。",
