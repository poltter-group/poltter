export const dict = {
  ...
  "dialog.provider.poltter.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.poltter.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.poltterGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Poltter",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Poltter-u.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.poltterZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.poltterZen.visit.prefix": "Posjeti ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Poltter-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Poltter-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u poltter.json",
  ...
  "dialog.server.description": "Promijeni na koji se Poltter server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingPoltter": "Provjera Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Provjera Poltter u distribuciji {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Ažuriranje Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Ažuriranje Poltter u distribuciji {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Ažuriraj Poltter u distribuciji {{distro}}.",
  "wsl.onboarding.updatePoltter": "Ažuriraj Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter je spreman.",
  "wsl.onboarding.installPoltterIn": "Instaliraj Poltter u distribuciji {{distro}}.",
  "wsl.onboarding.installPoltter": "Instaliraj Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Poltter mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Poltter nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Poltter.",
  ...
  "toast.update.description": "Nova verzija Poltter-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Poltter timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (poltter.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Poltter još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Poltter uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Poltter server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Poltter-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Poltter izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Poltter prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Poltter-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Poltter pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Poltter-a.",
