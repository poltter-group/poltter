...
export const dict = {
  ...
  "dialog.provider.poltter.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.poltter.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.poltterGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Poltter",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Poltter.",
  ...
  "provider.connect.poltterZen.line1":
    "Poltter Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Poltter.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i poltter.json",
  ...
  "dialog.server.description": "Bytt hvilken Poltter-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Poltter ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Poltter-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (poltter.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Poltter ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Poltter inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Poltter-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Poltter",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Poltter ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Poltter skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Poltter er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Poltter starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Poltter.",
  ...
  "wsl.onboarding.checkingPoltter": "Sjekker Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Sjekker Poltter i {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Oppdaterer Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Oppdaterer Poltter i {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Oppdater Poltter i {{distro}}.",
  "wsl.onboarding.updatePoltter": "Oppdater Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Poltter kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Poltter kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Poltter på nytt.",
