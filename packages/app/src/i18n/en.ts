export const dict = {
  ...
  "dialog.provider.poltter.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.poltter.tagline": "Reliable optimized models",
  "dialog.provider.poltterGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Poltter",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Poltter.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.poltterZen.line1":
    "Poltter Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.poltterZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.poltterZen.visit.prefix": "Visit ",
  "provider.connect.poltterZen.visit.link": "poltter.ai/zen",
  "provider.connect.poltterZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Poltter.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Poltter.",
  ...
  "dialog.plugins.empty": "Plugins configured in poltter.json",
  ...
  "dialog.server.description": "Switch which Poltter server this app connects to.",
  ...
  "wsl.onboarding.step.poltter": "Poltter",
  ...
  "wsl.onboarding.checkingPoltter": "Checking Poltter...",
  "wsl.onboarding.checkingPoltterIn": "Checking Poltter in {{distro}}...",
  "wsl.onboarding.updatingPoltter": "Updating Poltter...",
  "wsl.onboarding.updatingPoltterIn": "Updating Poltter in {{distro}}...",
  "wsl.onboarding.updatePoltterIn": "Update Poltter in {{distro}}.",
  "wsl.onboarding.updatePoltter": "Update Poltter",
  "wsl.onboarding.poltterReadyIn": "Poltter is ready in {{distro}}.",
  "wsl.onboarding.poltterReady": "Poltter is ready.",
  "wsl.onboarding.installPoltterIn": "Install Poltter in {{distro}}.",
  "wsl.onboarding.installPoltter": "Install Poltter",
  ...
  "wsl.onboarding.distroStatus.poltterMissing": "Poltter not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Poltter can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Poltter could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Poltter.",
  ...
  "toast.update.description": "A new version of Poltter ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Poltter team",
  ...
  "error.chain.checkConfig": "Check your config (poltter.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Poltter does not support MCP authentication yet.',
  ...
  "status.popover.tab.integrations": "Integrations",
  "status.popover.action.manageServers": "Manage servers",
  "status.popover.integrations.telegram.title": "Telegram Bot",
  "status.popover.integrations.telegram.botToken": "Bot Token",
  "status.popover.integrations.telegram.botToken.placeholder": "123456789:ABCdef...",
  "status.popover.integrations.telegram.chatId": "Chat ID",
  "status.popover.integrations.telegram.chatId.placeholder": "-1001234567890",
  "status.popover.integrations.telegram.save": "Connect",
  "status.popover.integrations.telegram.connected": "Telegram connected",
  "status.popover.integrations.apiKey.title": "API Key",
  "status.popover.integrations.apiKey.key": "API Key",
  "status.popover.integrations.apiKey.key.placeholder": "sk-...",
  "status.popover.integrations.apiKey.save": "Connect",
  "status.popover.integrations.apiKey.connected": "API key saved",
  ...
  "sidebar.gettingStarted.line1": "Poltter includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Poltter Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Poltter server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Poltter",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Poltter looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Poltter follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Poltter is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Poltter launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Poltter.",
  ...
  "settings.mcp.dialog.editTitle": "Edit {{name}}",
  "settings.mcp.dialog.name": "Server Name",
  "settings.mcp.dialog.type": "Type",
  "settings.mcp.dialog.url": "URL",
  "settings.mcp.dialog.command": "Command",
  "settings.mcp.dialog.env": "Environment Variable",
  "settings.mcp.toast.added": "MCP server added",
  "settings.mcp.toast.updated": "MCP server updated",
  "settings.mcp.toast.removed": "MCP server removed",
  "settings.skills.title": "Skills",
  "settings.skills.create": "Create Skill",
  "settings.skills.remove": "Remove skill",
  "settings.skills.form.name": "Name",
  "settings.skills.form.description": "Description",
  "settings.skills.form.descriptionPlaceholder": "What this skill does…",
  "settings.skills.form.create": "Create",

  "settings.integrations.title": "Integrations",
  "settings.integrations.reveal.show": "Show",
  "settings.integrations.reveal.hide": "Hide",
  "settings.integrations.telegram.title": "Telegram Bot",
  "settings.integrations.telegram.description": "Connect a Telegram bot to receive notifications and send messages.",
  "settings.integrations.telegram.botToken.label": "Bot Token",
  "settings.integrations.telegram.botToken.description": "The token from @BotFather.",
  "settings.integrations.telegram.botToken.placeholder": "123456789:ABCdefGHIjklMNOpqrsTUV...",
  "settings.integrations.telegram.chatId.label": "Chat ID",
  "settings.integrations.telegram.chatId.description": "The ID of the chat or group to send messages to.",
  "settings.integrations.telegram.chatId.placeholder": "-1001234567890",
  "settings.integrations.telegram.connect": "Connect",
  "settings.integrations.telegram.connect.description": "Verify the bot token and connect to Telegram.",
  "settings.integrations.telegram.connected": "Connected",
  "settings.integrations.telegram.disconnect": "Disconnect",
  "settings.integrations.telegram.disconnect.description": "Remove the stored credentials and disconnect Telegram.",
  "settings.integrations.telegram.toast.connected": "Telegram bot connected",
  "settings.integrations.telegram.toast.disconnected": "Telegram bot disconnected",
  "settings.integrations.apiKey.title": "Poltter API Key",
  "settings.integrations.apiKey.description": "Set your Poltter API key for authentication.",
  "settings.integrations.apiKey.apiKey.label": "API Key",
  "settings.integrations.apiKey.apiKey.description": "Your Poltter API key.",
  "settings.integrations.apiKey.apiKey.placeholder": "sk-........................................",
  "settings.integrations.apiKey.connect": "Connect",
  "settings.integrations.apiKey.connect.description": "Save your API key.",
  "settings.integrations.apiKey.connected": "Connected",
  "settings.integrations.apiKey.disconnect": "Disconnect",
  "settings.integrations.apiKey.toast.connected": "API key saved",
  "settings.integrations.apiKey.toast.disconnected": "API key removed",
  "settings.integrations.apiKey.comingSoon": "Coming Soon",

  "settings.section.account": "Account",
  "settings.upgrade.title": "Upgrade",
  "settings.upgrade.description": "Choose the plan that works best for you.",
  "settings.upgrade.currentPlan": "Current Plan",
  "settings.upgrade.plan.free.name": "Free",
  "settings.upgrade.plan.free.feature.1": "Unlimited local sessions",
  "settings.upgrade.plan.free.feature.2": "Basic model access",
  "settings.upgrade.plan.free.feature.3": "Community support",
  "settings.upgrade.plan.free.feature.4": "Core tools and skills",
  "settings.upgrade.plan.free.cta": "Current Plan",
  "settings.upgrade.plan.pro.name": "Pro",
  "settings.upgrade.plan.pro.feature.1": "Everything in Free",
  "settings.upgrade.plan.pro.feature.2": "Advanced model access (GPT-4, Claude Opus)",
  "settings.upgrade.plan.pro.feature.3": "Cloud session sync",
  "settings.upgrade.plan.pro.feature.4": "Priority support",
  "settings.upgrade.plan.pro.feature.5": "Extended tool permissions",
  "settings.upgrade.plan.pro.cta": "Upgrade to Pro",
  "settings.upgrade.plan.enterprise.name": "Enterprise",
  "settings.upgrade.plan.enterprise.feature.1": "Everything in Pro",
  "settings.upgrade.plan.enterprise.feature.2": "Team collaboration",
  "settings.upgrade.plan.enterprise.feature.3": "Custom model deployment",
  "settings.upgrade.plan.enterprise.feature.4": "SSO and audit logs",
  "settings.upgrade.plan.enterprise.feature.5": "Dedicated support",
  "settings.upgrade.plan.enterprise.feature.6": "SLA guarantee",
  "settings.upgrade.plan.enterprise.cta": "Contact Sales",
  ...
  "call.end": "End call",
  "call.holdToTalk": "Talk",
  "call.releaseToSend": "Release to send",
  "call.working": "Thinking",
  "call.speaking": "Speaking",
  "call.listening": "Listening",
  "call.paused": "Paused",
  "call.speakReplies": "Speak replies",
  "call.unavailable": "Voice call is unavailable right now",
  "call.sendFailed": "Couldn't send your message",
  "call.empty": "Tap the microphone and start talking",
  "call.me": "You",
  "call.polly": "Poltter",
}
