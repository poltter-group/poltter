...
class Database extends Context.Service<Database, DatabaseShape>()("@poltter/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@poltter/example/UserStore") {
