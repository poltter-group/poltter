---
title: Share
description: Share your Poltter conversations.
---

Poltter's share feature allows you to create public links to your Poltter conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Poltter:
...
Poltter supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Poltter uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `poltter.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using poltter in your organization.
