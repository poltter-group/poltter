...
Crear `.poltter/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Poltter o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Poltter [config](/docs/config):
...
poltter incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
