...
สร้าง `.poltter/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Poltter:
...
- ระดับผู้ใช้ (Global): `~/.config/poltter/commands/`
- ระดับโปรเจ็กต์: `.poltter/commands/`
...
Poltter มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
