---
title: TUI
description: Bruke poltter-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Poltter gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Poltter starter TUI for gjeldende katalog.
...
Når du bruker Poltter TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Poltter. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Poltter. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `poltter.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Poltter venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `poltter.default`.
