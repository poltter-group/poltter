---
title: Zen
description: Utvalgt liste over modeller levert av Poltter.
---
...
Poltter Zen er en liste over testede og verifiserte modeller levert av Poltter-teamet.

Zen fungerer som enhver annen leverandør i Poltter. Du logger inn på Poltter Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Poltter.
:::
...
Poltter Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Poltter Zen fungerer som enhver annen leverandør i Poltter.

1. Du logger inn på **<a href={console}>Poltter Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Poltter Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Poltter-konfigurasjonen din
bruker formatet `poltter/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `poltter/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Poltter bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling-3.0-flash Free er tilgjengelig på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Poltter i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet Poltter Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Poltter også.
