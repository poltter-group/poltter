---
title: LSP-servere
description: poltter integreres med LSP-serverne dine.
---

Poltter kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Poltter kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `POLTTER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og poltter åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Poltter-konfigurasjonen.
