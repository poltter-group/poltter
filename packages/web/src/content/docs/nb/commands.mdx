...
Opprett `.poltter/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Poltter-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Poltter [config](/docs/config):
...
Poltter inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
