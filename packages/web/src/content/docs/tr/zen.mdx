---
title: Zen
description: poltter tarafından sağlanan seçilmiş modeller listesi.
---
...
Poltter Zen, Poltter ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Poltter'daki diğer sağlayıcılar gibi çalışır. Poltter Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Poltter kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Poltter ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Poltter Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Poltter Zen, Poltter'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Poltter Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Poltter Zen'i seçin ve API anahtarınızı yapıştırın.
...
Poltter yapılandırmanızdaki [model id](/docs/config/#models) `poltter/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `poltter/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. Poltter, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Poltter'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Poltter'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için Poltter'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling-3.0-flash Free, sınırlı bir süre için Poltter'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Poltter'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Poltter'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Poltter'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Poltter Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Poltter ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
