---
title: Paylasim
description: poltter konusmalarini genel baglantilarla paylasin.
---

poltter'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda poltter:
...
poltter, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak poltter manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `poltter.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda poltter kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
