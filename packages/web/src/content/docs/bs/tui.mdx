---
title: TUI
description: Korištenje korisničkog interfejsa Poltter terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Poltter pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Poltter pokreće TUI za trenutni direktorij.
...
Kada koristite Poltter TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Poltter. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Poltter. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `poltter.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Poltter čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `poltter.default`.
