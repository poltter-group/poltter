...
Kreiraj `.poltter/commands/test.md`:
...
Možete dodati prilagođene komande kroz Poltter konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Poltter [config](/docs/config):
...
- Globalno: `~/.config/poltter/commands/`
- Po projektu: `.poltter/commands/`
...
Poltter uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
