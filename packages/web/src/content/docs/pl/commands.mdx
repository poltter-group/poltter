...
Utwórz `.poltter/commands/test.md`:
...
Możesz zdefiniować polecenia w `poltter.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji poltter:
...
- Globalnie: `~/.config/poltter/commands/`
- Na projekt: `.poltter/commands/`
...
poltter zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
