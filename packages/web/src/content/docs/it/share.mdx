---
title: Condivisione
description: Condividi le tue conversazioni Poltter.
---

La funzione di condivisione di Poltter ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Poltter:
...
Poltter supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Poltter usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `poltter.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare poltter nella tua organizzazione.
