...
Puoi aggiungere comandi personalizzati tramite la config di Poltter o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Poltter:
...
- Globale: `~/.config/poltter/commands/`
- Per progetto: `.poltter/commands/`
...
poltter include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
