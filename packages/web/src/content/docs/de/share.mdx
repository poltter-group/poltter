---
title: Teilen
description: Teile Poltter-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Poltter-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Poltter Folgendes:
...
Poltter hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Poltter den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`poltter.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du poltter in deiner Organisation einsetzt.
