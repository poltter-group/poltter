...
description: Opret værktøjer, som LLM kan kalde poltter ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med poltters [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.poltter/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/poltter/tools/`.
