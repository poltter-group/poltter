...
Opret `.poltter/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Poltter-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Poltter [config](/docs/config):
...
- Globalt: `~/.config/poltter/commands/`
- Pr. projekt: `.poltter/commands/`
...
poltter indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
