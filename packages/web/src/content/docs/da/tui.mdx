---
title: TUI
description: Brug af Poltter-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Poltter giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Poltter starter TUI for den nuværende mappe.
...
Når du bruger Poltter TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Poltter. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Poltter. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `poltter.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Poltter venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `poltter.default`.
