---
title: LSP-servere
description: Poltter integreres med dine LSP-servere.
---

Poltter kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Poltter leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `POLTTER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og poltter åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din poltter-konfiguration.
