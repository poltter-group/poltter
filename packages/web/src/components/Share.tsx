...
import { IconPoltter } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "poltter/session/message-v2"
import type { Message } from "poltter/session/message"
import type { Session } from "poltter/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.poltter_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.poltter_name}>
                    <IconPoltter width={16} height={16} />
                  </div>
