...
Schema-first LLM core for poltter. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@poltter-ai/llm"
import { OpenAI } from "@poltter-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@poltter-ai/llm/providers"
