...
```
REGISTRY=ghcr.io/poltter-group TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/poltter-group TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/poltter-group/build/bun-node:24.04
```
