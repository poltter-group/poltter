...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "POLTTER.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/poltter/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/poltter (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/poltter/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/poltter/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const POLTTER_DB|POLTTER_DB|POLTTER_DEV|Global\\.Path\\.data|data =" in packages/poltter/src (115 matches)',
  },
] as const
