...
import { useBindings, usePoltterModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = usePoltterModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.POLTTER_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
