...
import { registerPoltterSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@poltter-ai/sdk/v2"
...
import { POLTTER_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, usePoltterKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.POLTTER_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
