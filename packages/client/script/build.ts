...
import { compile, emitEffectImported, emitPromise, write } from "@poltter-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "PoltterEventEncoded",
              import: 'import type { PoltterEventEncoded } from "@poltter-ai/protocol/groups/event"',
            },
          },
        }),
