import type { PluginContext } from "@poltter-ai/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@poltter-ai/sdk/v2/types"
