...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@poltter-ai/schema/prompt"
import { Provider } from "@poltter-ai/schema/provider"
import { Project } from "@poltter-ai/schema/project"
import { ProjectDirectories } from "@poltter-ai/schema/project-directories"
import { PermissionV1 } from "@poltter-ai/schema/permission-v1"
...
import { Command } from "@poltter-ai/schema/command"
import { Connection } from "@poltter-ai/schema/connection"
import { Credential } from "@poltter-ai/schema/credential"
import { FileSystem } from "@poltter-ai/schema/filesystem"
import { Integration } from "@poltter-ai/schema/integration"
import { LLM } from "@poltter-ai/schema/llm"
import { Permission } from "@poltter-ai/schema/permission"
import { Plugin } from "@poltter-ai/schema/plugin"
import { Pty } from "@poltter-ai/schema/pty"
import { Reference } from "@poltter-ai/schema/reference"
import { SessionTodo } from "@poltter-ai/schema/session-todo"
import { Skill } from "@poltter-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@poltter-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@poltter-ai/core/command"),
    import("@poltter-ai/core/integration/connection"),
    import("@poltter-ai/core/credential"),
    import("@poltter-ai/core/filesystem"),
    import("@poltter-ai/core/integration"),
    import("@poltter-ai/core/location"),
    import("@poltter-ai/llm"),
    import("@poltter-ai/core/permission"),
    import("@poltter-ai/core/v1/permission"),
    import("@poltter-ai/core/project/copy"),
    import("@poltter-ai/core/pty"),
    import("@poltter-ai/core/project/schema"),
    import("@poltter-ai/core/reference"),
    import("@poltter-ai/core/session/input"),
    import("@poltter-ai/core/session/message"),
    import("@poltter-ai/core/session/todo"),
    import("@poltter-ai/core/session/prompt"),
    import("@poltter-ai/core/skill"),
    import("@poltter-ai/core/v2-schema"),
    import("@poltter-ai/core/schema"),
    import("@poltter-ai/core/workspace"),
  ])
