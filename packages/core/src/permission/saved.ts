...
import { PermissionSaved } from "@poltter-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/v2/PermissionSaved") {}
