...
import { ListAnchor } from "@poltter-ai/schema/session"
...
import { SessionDurable } from "@poltter-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/v2/Session") {}
