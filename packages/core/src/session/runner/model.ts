...
import { type Model } from "@poltter-ai/llm"
import * as AnthropicMessages from "@poltter-ai/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@poltter-ai/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@poltter-ai/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@poltter-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/v2/SessionRunnerModel") {}
