...
import type { EffectDrizzleSqlite } from "@poltter-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/ProjectDirectories") {}
