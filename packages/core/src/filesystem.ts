...
import { Entry, FileSystem, FindInput, Match } from "@poltter-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@poltter-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/v2/FileSystem") {}
