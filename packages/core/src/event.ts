...
import type { Data, Definition, Payload } from "@poltter-ai/schema/event"
...
import { Durable } from "@poltter-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@poltter-ai/schema/event").ID
export type { Data, Definition, Payload } from "@poltter-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/Event") {}
