...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@poltter-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/v2/ToolRegistry") {}
