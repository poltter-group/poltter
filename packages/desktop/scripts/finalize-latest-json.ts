...
const releaseId = process.env.POLTTER_RELEASE
if (!releaseId) throw new Error("POLTTER_RELEASE is required")

const version = process.env.POLTTER_VERSION
if (!version) throw new Error("POLTTER_VERSION is required")
...
const macxTarGz = "poltter-desktop-mac-x64.app.tar.gz"
const macaTarGz = "poltter-desktop-mac-arm64.app.tar.gz"
