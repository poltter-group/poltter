export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Poltter",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Poltter has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'poltter' command.",
  "desktop.cli.failed.title": "Installation Failed",
  "desktop.cli.failed.message": "Failed to install CLI: {{error}}",
  "desktop.cli.notAvailable.message": "CLI installation is not available in this version.",
}
