export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Poltter",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Poltter. ¿Quieres instalarla y reiniciar?",
