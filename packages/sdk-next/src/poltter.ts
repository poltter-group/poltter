import { Poltter } from "@poltter-ai/client/effect"
...
import { createEmbeddedRoutes } from "@poltter-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Poltter.create")(function* () {
  ...
  const client = yield* Poltter.make({ baseUrl: "http://poltter.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@poltter-ai/sdk-next/Poltter") {}
