export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Poltter Data",
  "app.description":
    "Explora el uso de Poltter Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Poltter Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Poltter en GitHub",
  "header.github": "GitHub",
  "header.tryPoltter": "Probar Poltter",
  ...
  "footer.homeAria": "Inicio de Poltter",
  ...
  "modal.title": "Boletín de Poltter",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Poltter Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Poltter Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Poltter Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Poltter Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Poltter.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Poltter",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Poltter",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Poltter durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Poltter Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Poltter Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Poltter Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Poltter Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Poltter Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Poltter Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Poltter Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Poltter Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Poltter Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Poltter Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Poltter Go.",
  ...
  "model.geoDescription": "Tokens del modelo de Poltter Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de Poltter Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Poltter Go.",
