export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Poltter Data",
  "app.description":
    "Poltter Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Poltter Data logosu",
  ...
  "header.githubAria": "GitHub'da Poltter'a yıldız ver",
  "header.github": "GitHub",
  "header.tryPoltter": "Poltter'u dene",
  ...
  "footer.homeAria": "Poltter ana sayfası",
  ...
  "home.topModelsDescription": "Poltter Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Poltter Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Poltter Data",
  "lab.description":
    "Poltter Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Poltter kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Poltter'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Poltter kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Poltter token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Poltter Data",
  "model.description":
    "{{model}} için Poltter Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Poltter Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Poltter Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Poltter Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Poltter Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Poltter Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Poltter Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Poltter Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Poltter Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Poltter Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Poltter Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Poltter Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Poltter Go token hacmine göre yakındaki modeller.",
