export const dict = {
  "app.title": "Rankingi użycia modeli AI | Poltter Data",
  "app.description":
    "Przeglądaj użycie Poltter Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Poltter Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Poltter na GitHub",
  "header.github": "GitHub",
  "header.tryPoltter": "Wypróbuj Poltter",
  ...
  "footer.homeAria": "Strona główna Poltter",
  ...
  "home.topModelsDescription": "Użycie modeli w Poltter Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Poltter Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Poltter Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Poltter Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Poltter.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Poltter",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Poltter",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Poltter z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Poltter Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Poltter Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Poltter Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Poltter Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Poltter Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Poltter Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Poltter Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Poltter Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Poltter Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Poltter Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Poltter Go.",
  ...
  "model.geoDescription": "Tokeny modelu Poltter Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Poltter Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Poltter Go.",
