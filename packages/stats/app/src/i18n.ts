...
const en = {
  "app.title": "AI Model Usage Rankings | Poltter Data",
  "app.description":
    "Explore Poltter Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Poltter Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Poltter on GitHub",
  "header.github": "GitHub",
  "header.tryPoltter": "Try Poltter",
  ...
  "home.topModelsDescription": "Usage of models across Poltter Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Poltter Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Poltter Data",
  "lab.description":
    "Compare {{lab}} models used in Poltter Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Poltter usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Poltter",
  ...
  "lab.shareOfUsage": "{{share}} of recent Poltter usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Poltter Data",
  "model.description":
    "View {{model}} Poltter Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Poltter Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Poltter Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Poltter Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Poltter Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Poltter Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Poltter Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Poltter Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Poltter Go token volume.",
