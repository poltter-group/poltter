import poltterWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const themeStorageKey = "poltter:stats-theme"
      ...
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://opencode.ai/">
            <strong>{i18n.t("header.tryPoltter")}</strong>
          </a>
          <button
...
function PoltterMark() {
  return (
    <svg data-slot="poltter-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const connect = [
    ...
    { href: "https://x.com/poltter", label: "X" },
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={poltterWordmarkDark} alt="Poltter" />
          <button
