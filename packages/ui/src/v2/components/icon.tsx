...
const icons = {
  ...
  phone: {
    viewBox: "0 0 20 20",
    body: `<path d="M7.08333 3.125C7.08333 3.125 6.875 3.125 6.66667 3.125C5.83333 3.125 5 3.95833 5 4.79167C5 12.0833 7.91667 15 15.2083 15C16.0417 15 16.875 14.1667 16.875 13.3333C16.875 13.125 16.875 12.9167 16.875 12.9167L14.1667 11.4583L12.5 12.5C11.25 11.6667 8.33333 8.75 7.5 7.5L8.54167 5.83333L7.08333 3.125Z" stroke="currentColor" stroke-linecap="square"/>`,
  },
  "phone-active": {
    viewBox: "0 0 20 20",
    body: `<path d="M7.08333 3.125C7.08333 3.125 6.875 3.125 6.66667 3.125C5.83333 3.125 5 3.95833 5 4.79167C5 12.0833 7.91667 15 15.2083 15C16.0417 15 16.875 14.1667 16.875 13.3333C16.875 13.125 16.875 12.9167 16.875 12.9167L14.1667 11.4583L12.5 12.5C11.25 11.6667 8.33333 8.75 7.5 7.5L8.54167 5.83333L7.08333 3.125Z" fill="currentColor" fill-opacity="0.1"/><path d="M7.08333 3.125C7.08333 3.125 6.875 3.125 6.66667 3.125C5.83333 3.125 5 3.95833 5 4.79167C5 12.0833 7.91667 15 15.2083 15C16.0417 15 16.875 14.1667 16.875 13.3333C16.875 13.125 16.875 12.9167 16.875 12.9167L14.1667 11.4583L12.5 12.5C11.25 11.6667 8.33333 8.75 7.5 7.5L8.54167 5.83333L7.08333 3.125Z" stroke="currentColor" stroke-linecap="square"/>`,
  },
  person: {
    viewBox: "0 0 20 20",
    body: `<path d="M10 10C12.0711 10 13.75 8.32107 13.75 6.25C13.75 4.17893 12.0711 2.5 10 2.5C7.92893 2.5 6.25 4.17893 6.25 6.25C6.25 8.32107 7.92893 10 10 10Z" stroke="currentColor" stroke-linecap="square"/><path d="M3.4375 17.9167C4.21875 14.7917 6.45833 13.3333 10 13.3333C13.5417 13.3333 15.7813 14.7917 16.5625 17.9167" stroke="currentColor" stroke-linecap="square"/>`,
  },
  robot: {
    viewBox: "0 0 20 20",
    body: `<path d="M5 7.5V11.25C5 13 6.5 14.5 8.75 14.5H11.25C13.5 14.5 15 13 15 11.25V7.5C15 5 13.5 3.5 11.25 3.5H8.75C6.5 3.5 5 5 5 7.5Z" stroke="currentColor" stroke-linecap="square"/><path d="M3.75 8.75H5M3.75 10.25H5M15 8.75H16.25M15 10.25H16.25" stroke="currentColor" stroke-linecap="square"/><path d="M10 1.25V2.75" stroke="currentColor" stroke-linecap="square"/><circle cx="10" cy="1" r="0.4" fill="currentColor"/><circle cx="8.125" cy="9.25" r="0.5" fill="currentColor"/><circle cx="11.875" cy="9.25" r="0.5" fill="currentColor"/>`,
  },
  "outline-sliders": {
    viewBox: "0 0 16 16",
  ...
  eye: {
    viewBox: "0 0 16 16",
    body: `<path d="M1.5 8C1.5 8 4 3.5 8 3.5C12 3.5 14.5 8 14.5 8C14.5 8 12 12.5 8 12.5C4 12.5 1.5 8 1.5 8Z" stroke="currentColor" stroke-linejoin="round"/><path d="M8 10C9.10457 10 10 9.10457 10 8C10 6.89543 9.10457 6 8 6C6.89543 6 6 6.89543 6 8C6 9.10457 6.89543 10 8 10Z" stroke="currentColor"/>`,
  },
  "eye-off": {
    viewBox: "0 0 16 16",
    body: `<path d="M2 2L14 14" stroke="currentColor" stroke-linecap="round"/><path d="M6.35 4.22C6.88 4.07 7.43 4 8 4C12 4 14.5 8 14.5 8C13.94 9.13 13.22 10.08 12.42 10.83M3.65 5.87C2.6 6.68 2 8 2 8C2 8 4 12.5 8 12.5C9.13 12.5 10.17 12.13 11.08 11.5" stroke="currentColor" stroke-linejoin="round"/><path d="M8 10.2C8.78 10.2 9.4 9.58 9.4 8.8C9.4 8.36 9.21 7.97 8.92 7.71" stroke="currentColor" stroke-linejoin="round"/>`,
  },
}

const spriteID = "poltter-v2-icon-sprite"
const symbol = (name: keyof typeof icons) => `poltter-v2-icon-${name}`
