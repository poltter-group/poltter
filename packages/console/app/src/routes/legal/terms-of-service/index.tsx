...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Poltter | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Poltter terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Poltter. Please read on to learn the rules and restrictions that govern your use of
                Poltter&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Poltter," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://poltter.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-poltter">What is Poltter?</h2>
              <p>
                Poltter is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Poltter Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Poltter enables you to
              ...
              <p>
                ...
                our site located at poltter.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Poltter takes the privacy of its users very seriously. For the current Poltter Privacy Policy, please
                click here{" "}
                <a href="https://poltter.ai/legal/privacy-policy">https://poltter.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Poltter?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Poltter;
                </li>
                <li>
              ...
              <p>
                If you use Poltter with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Poltter. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Poltter has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-poltter-ever-change-the-services">Will Poltter ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://poltter.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://poltter.ai/auth">https://poltter.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://poltter.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Poltter is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Poltter has the sole right to decide whether you are
              ...
              <p>
                Poltter and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Poltter and all such
                parties together, the "Poltter Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Poltter Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Poltter Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY POLTTER (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                POLTTER PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO POLTTER IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Poltter Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Poltter's prior written
              ...
              <p>
                ...
                disputes and claims with Poltter and limits the manner in which you can seek relief from Poltter. Both
                you and Poltter acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Poltter's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Poltter will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Poltter will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Poltter may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND POLTTER WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Poltter are instead choosing to have claims and disputes resolved by
                ...
                you and Poltter over whether to vacate or enforce an arbitration award, YOU AND POLTTER WAIVE ALL
              ...
              <p>
                ...
                Poltter is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Poltter to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Poltter agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Poltter may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Poltter agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Poltter, and
                ...
                are not an employee, agent, partner, or joint venture of Poltter, and you do not have any authority of
                any kind to bind Poltter in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Poltter
