        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g poltter-ai")}>
                <code>
                  npm i -g <strong>poltter-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g poltter-ai")}>
                <code>
                  bun add -g <strong>poltter-ai</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S poltter")}>
                <code>
                  paru -S <strong>poltter</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask poltter-desktop")}>
                <code>
                  brew install --cask <strong>poltter-desktop</strong>
                </code>
                <CopyStatus />
              </button>
