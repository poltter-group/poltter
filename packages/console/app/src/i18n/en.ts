export const dict = {
  ...
  "notFound.title": "Not Found | poltter",
  "notFound.heading": "404 - Page Not Found",
  "notFound.home": "Home",
  "notFound.docs": "Docs",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "poltter logo light",
  "notFound.logoDarkAlt": "poltter logo dark",
  ...
  "auth.email.subtitle": "Enter your email to receive a verification code",
  "auth.email.placeholder": "Enter your email address",
  "auth.email.submit": "Send code",
  "auth.email.error.invalidEmail": "Please enter a valid email address",

  "auth.code.title": "Enter verification code",
  "auth.code.subtitle": "We sent a code to {{email}}",
  "auth.code.placeholder": "Enter 6-digit code",
  "auth.code.submit": "Verify",
  "auth.code.error.invalidCode": "Invalid code, please try again",
  "auth.code.error.expired": "Code expired, please request a new one",
  "auth.code.resend": "Resend code",
  "auth.code.resendSuccess": "New code sent!",
  ...
  "app.meta.description": "Poltter - The open source coding agent.",

  "home.title": "Poltter | The open source AI coding agent",

  "temp.title": "poltter | AI coding agent built for the terminal",
  "temp.hero.title": "The AI coding agent built for the terminal",
  "temp.zen": "poltter zen",
  ...
  "temp.feature.zen.afterLink": "provided by poltter",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "poltter TUI with the tokyonight theme",
  "temp.screenshot.alt": "poltter TUI with tokyonight theme",
  "temp.logoLightAlt": "poltter logo light",
  "temp.logoDarkAlt": "poltter logo dark",
  ...
  "home.what.title": "What is Poltter?",
  "home.what.body": "Poltter is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Poltter is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Poltter does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Poltter?",
  "home.faq.a1":
    "Poltter is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Poltter?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Poltter?",
  "home.faq.a3.p1":
    "Not necessarily, Poltter comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Poltter also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Poltter?",
  "home.faq.a4.p1":
    "Yes, Poltter supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Poltter in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Poltter is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Poltter cost?",
  "home.faq.a6":
    "Poltter is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Poltter open source?",
  "home.faq.a8.p1": "Yes, Poltter is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Poltter has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "Poltter Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Poltter has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is Poltter Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Poltter.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Poltter can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Poltter adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Poltter, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Poltter users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Poltter, you can use Zen with any agent.",
  ...
  "go.title": "Poltter Go | Low cost coding models for everyone",
  ...
  "go.testimonials.handle": "@Poltter",
  ...
  "go.problem.body":
    "We're focused on bringing the Poltter experience to as many people as possible. Poltter Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with Poltter or any agent.",
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model by subscribing to Poltter Go - {{link}}",

  "black.meta.title": "Poltter Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with Poltter Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "Poltter Black | Pricing",
  ...
  "black.workspace.title": "Poltter Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to Poltter Black",
  ...
  "black.subscribe.success.title": "You're on the Poltter Black waitlist",
  "black.subscribe.success.subscriptionPlan": "Subscription plan",
  "black.subscribe.success.planName": "Poltter Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with poltter whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select poltter",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start poltter and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing poltter services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an poltter Gateway API key",
  ...
  "workspace.subscription.title": "Subscription",
  "workspace.subscription.subtitle": "Your current plan and subscription status.",
  "workspace.subscription.status": "Status",
  "workspace.subscription.seats": "Seats",
  "workspace.subscription.type": "Type",
  "workspace.subscription.manage": "Manage Subscription",
  "workspace.subscription.upgrade": "Upgrade Plan",
  "workspace.subscription.paymentFailed": "Payment Failed",
  "workspace.subscription.lastAttempt": "Last attempt",
  "workspace.subscription.updatePayment": "Update Payment Method",
  "workspace.subscription.paymentMethod": "Payment Method",
  "workspace.subscription.currentBalance": "Current Balance",
  ...
  "workspace.black.subscription.message": "You are subscribed to Poltter Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month Poltter Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month Poltter Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to Poltter Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "Poltter Go" as the provider in your poltter configuration to use Go models.',
  ...
  "workspace.lite.black.message":
    "You're currently subscribed to Poltter Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to Poltter Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "Poltter Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.title": "Poltter | Download",
  "download.meta.description": "Download Poltter for macOS, Windows, and Linux",
  "download.hero.title": "Download Poltter Desktop",
  "download.hero.subtitle": "Available in Beta for macOS, Windows, and Linux",
  "download.hero.button": "Download for {{os}}",
  "download.section.terminal": "Poltter Terminal",
  "download.section.desktop": "Poltter Desktop",
  "download.section.extensions": "Poltter Extensions",
  "download.section.integrations": "Poltter Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Poltter to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Poltter works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Poltter is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Poltter works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Poltter.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Poltter | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Poltter for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Poltter operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Poltter Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with Poltter Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Poltter by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Poltter Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.title": "Poltter | Brand",
  "brand.meta.description": "Poltter brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Poltter brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Poltter | Changelog",
  "changelog.meta.description": "Poltter release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Poltter",
  ...
  "pricing.title": "Poltter | Pricing - Free, Go, and Black plans",
  "pricing.hero.title": "Simple pricing for every developer",
  "pricing.hero.body": "Start for free, upgrade when you need more. All plans include access to Poltter's core features.",

  "pricing.free.name": "Free",
  "pricing.free.price": "$0",
  "pricing.free.period": "forever",
  "pricing.free.desc": "Get started with Poltter's core features and free models.",
  "pricing.free.cta": "Get started",
  "pricing.free.feature1": "Access to free models (Big Pickle + promotions)",
  "pricing.free.feature2": "200 requests per day",
  "pricing.free.feature3": "Bring your own API keys",
  "pricing.free.feature4": "Terminal, desktop, and IDE support",

  "pricing.go.name": "Go",
  "pricing.go.price": "$5",
  "pricing.go.period": "first month, then $10/mo",
  "pricing.go.desc": "Low-cost access to capable open-source models for agentic coding.",
  "pricing.go.cta": "Subscribe to Go",
  "pricing.go.feature1": "17+ curated open-source models",
  "pricing.go.feature2": "Generous rolling, weekly, and monthly limits",
  "pricing.go.feature3": "Reliable access across US, EU, and Singapore",
  "pricing.go.feature4": "Alipay and UPI payment support",
  "pricing.go.feature5": "Cancel anytime",

  "pricing.black.name": "Black",
  "pricing.black.price": "$20",
  "pricing.black.period": "per month",
  "pricing.black.desc": "Access all the world's best coding models including Claude, GPT, and Gemini.",
  "pricing.black.cta": "View Black plans",
  "pricing.black.feature1": "Claude, GPT, Gemini, and more premium models",
  "pricing.black.feature2": "5-hour, weekly, and monthly usage limits",
  "pricing.black.feature3": "Use available balance after limits",
  "pricing.black.feature4": "Per-seat pricing for teams",
  "pricing.black.feature5": "$100 and $200 tiers for higher usage",
  "pricing.black.feature6": "Cancel anytime",

  "pricing.comparison.title": "Compare plans",
  "pricing.comparison.feature": "Feature",
  "pricing.comparison.freeModels": "Free models",
  "pricing.comparison.goModels": "Go models (open-source)",
  "pricing.comparison.premiumModels": "Premium models (Claude, GPT, Gemini)",
  "pricing.comparison.byok": "Bring your own API key",
  "pricing.comparison.autoReload": "Auto-reload",
  "pricing.comparison.autoReload.free": "-",
  "pricing.comparison.autoReload.go": "-",
  "pricing.comparison.autoReload.black": "Available",
  "pricing.comparison.limits": "Usage limits",
  "pricing.comparison.limits.free": "200 req/day",
  "pricing.comparison.limits.go": "Rolling + weekly + monthly",
  "pricing.comparison.limits.black": "5h + weekly + monthly",
  "pricing.comparison.support": "Support",
  "pricing.comparison.support.free": "Community",
  "pricing.comparison.support.go": "Community",
  "pricing.comparison.support.black": "Priority",

  "pricing.faq.q1": "What's the difference between Free, Go, and Black?",
  "pricing.faq.a1":
    "Free includes basic models with daily limits. Go ($5 first month, then $10/month) gives you 17+ curated open-source models with generous limits. Black ($20-$200/month) unlocks premium models like Claude, GPT, and Gemini.",
  "pricing.faq.q2": "Can I switch between plans?",
  "pricing.faq.a2":
    "Yes. You can upgrade from Free to Go or Black at any time. To switch between Go and Black, unsubscribe from one and subscribe to the other.",
  "pricing.faq.q3": "Do I need a separate AI subscription?",
  "pricing.faq.a3":
    "No. Poltter includes its own models. You can also bring your own API keys from providers like OpenAI, Anthropic, or xAI if you prefer.",
  ...
  "pricing.faq.a5":
    "We accept all major credit cards, Alipay, UPI, and Stripe Link. Payments are processed securely through Stripe.",
} as const
