...
export const TypeId: TypeId = "~@poltter-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@poltter-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@poltter-ai/effect-sqlite-node/NodeSqliteClient")
