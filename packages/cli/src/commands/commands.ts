...
declare const POLTTER_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof POLTTER_CLI_NAME === "string" ? POLTTER_CLI_NAME : "poltter", {
  description: "Poltter 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
