...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips poltter-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-poltter-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-poltter-directory")).toBeNull()
      expect(result.get("x-poltter-workspace")).toBeNull()
