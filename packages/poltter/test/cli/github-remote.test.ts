...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/poltter.git")).toEqual({ owner: "sst", repo: "poltter" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/poltter")).toEqual({ owner: "sst", repo: "poltter" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/poltter.git")).toEqual({ owner: "sst", repo: "poltter" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/poltter")).toEqual({ owner: "sst", repo: "poltter" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/poltter.git")).toEqual({ owner: "sst", repo: "poltter" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/poltter")).toEqual({ owner: "sst", repo: "poltter" })
})
