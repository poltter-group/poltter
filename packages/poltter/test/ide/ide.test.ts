...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders POLTTER_CALLER", () => {
    process.env["POLTTER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode POLTTER_CALLER", () => {
    process.env["POLTTER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown POLTTER_CALLER", () => {
    process.env["POLTTER_CALLER"] = "unknown"
