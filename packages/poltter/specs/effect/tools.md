...
Practical reference for the current tool-migration state in `packages/poltter`.
...
Tool tests should use the existing Effect helpers in `packages/poltter/test/lib/effect.ts`:
