...
import { AccountStateTable, AccountTable } from "@poltter-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/AccountRepo") {}
