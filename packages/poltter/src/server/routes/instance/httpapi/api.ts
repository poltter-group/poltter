...
import { makeApi } from "@poltter-ai/protocol/api"
import { LocationMiddleware } from "@poltter-ai/server/location"
import { SessionLocationMiddleware } from "@poltter-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("poltter-root")
...
export const InstanceHttpApi = HttpApi.make("poltter-instance")
...
export const PoltterHttpApi = HttpApi.make("poltter")
