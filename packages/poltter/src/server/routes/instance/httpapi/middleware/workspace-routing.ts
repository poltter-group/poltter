...
>()("@poltter/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@poltter/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.POLTTER_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.POLTTER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-poltter-directory"] || process.cwd()
}
