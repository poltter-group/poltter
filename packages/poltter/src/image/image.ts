...
export class Service extends Context.Service<Service, Interface>()("@poltter/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __POLTTER_PHOTON_WASM_PATH?: string }).__POLTTER_PHOTON_WASM_PATH =
