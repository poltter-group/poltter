...
import { Slug } from "@poltter-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@poltter-ai/llm"
...
import { locationServiceMapLayer } from "@poltter-ai/core/location-services"
...
import { PartTable, SessionTable } from "@poltter-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@poltter-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".poltter", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@poltter/Session") {}
