import type { JsonSchema, LLMRequest, ProviderMetadata } from "@poltter-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@poltter-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @poltter-ai/llm request objects from poltter's session/AI SDK-shaped data.
  return LLM.request({
