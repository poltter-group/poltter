...
import { EventSequenceTable, EventTable } from "@poltter-ai/core/event/sql"
...
import { WorkspaceEvent } from "@poltter-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        POLTTER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        POLTTER_WORKSPACE_ID: config.id,
        POLTTER_EXPERIMENTAL_WORKSPACES: "true",
