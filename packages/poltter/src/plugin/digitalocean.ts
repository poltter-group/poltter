...
import type { Model } from "@poltter-ai/sdk/v2"
import { InstallationVersion } from "@poltter-ai/core/installation/version"
import { OauthCallbackPage } from "@poltter-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Poltter will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
