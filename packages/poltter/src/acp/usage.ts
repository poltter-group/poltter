...
import type { AssistantMessage as PoltterAssistantMessage, Message } from "@poltter-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@poltter-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<PoltterAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<PoltterAssistantMessage, "role"> &
  Partial<Pick<PoltterAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@poltter/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@poltter/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@poltter/ACPUsage") {}
