...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@poltter/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@poltter/ACPDirectory") {}
