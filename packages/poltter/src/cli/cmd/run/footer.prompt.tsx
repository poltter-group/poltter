...
import { normalizePromptContent } from "@poltter-ai/tui/editor"
...
import { POLTTER_BASE_MODE, useBindings } from "@poltter-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Poltter" } satisfies SlashOption,
    ]
