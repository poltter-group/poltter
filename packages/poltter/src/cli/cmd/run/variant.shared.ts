...
//
// The saved variant persists across sessions in ~/.local/state/poltter/model.json
...
class Service extends Context.Service<Service, VariantService>()("@poltter/RunVariant") {}
