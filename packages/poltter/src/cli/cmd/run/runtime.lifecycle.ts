...
import { openEditor } from "@poltter-ai/tui/editor"
import { registerPoltterKeymap } from "@poltter-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerPoltterKeymap(keymap, renderer, input.tuiConfig)
