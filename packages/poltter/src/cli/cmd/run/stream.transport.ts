...
import type { Event, GlobalEvent, PoltterClient } from "@poltter-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@poltter/RunStreamTransport") {}
