...
import { ProjectDirectoryTable, ProjectTable } from "@poltter-ai/core/project/sql"
import { ProjectDirectories } from "@poltter-ai/core/project/directories"
...
import { which } from "@poltter-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.POLTTER_FAKE_VCS)
