 ...
 *   "@poltter/ServerAuthConfig",
 *   {
 *     password: Config.string("POLTTER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("POLTTER_SERVER_USERNAME").pipe(Config.withDefault("poltter")),
 *   },
 * ) {}
 *
