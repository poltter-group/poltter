...
import type * as SDK from "@poltter-ai/sdk/v2"
...
import { SessionShareTable } from "@poltter-ai/core/share/sql"
...
const disabled = process.env["POLTTER_DISABLE_SHARE"] === "true" || process.env["POLTTER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@poltter/ShareNext") {}
