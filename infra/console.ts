...
export const auth = new sst.cloudflare.Worker("AuthApi", {
  ...
  url: true,
  link: [database, authStorage, GITHUB_CLIENT_ID_CONSOLE, GITHUB_CLIENT_SECRET_CONSOLE, GOOGLE_CLIENT_ID, AWS_SES_ACCESS_KEY_ID, AWS_SES_SECRET_ACCESS_KEY],
})
