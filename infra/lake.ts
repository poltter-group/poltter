...
const tableBucketName = `poltter-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `poltter-${$app.stage}-lake-ingest`,
    destination: "iceberg",
