...
- PR #10018: https://github.com/poltter-group/poltter/pull/10018
- PR #12935: https://github.com/poltter-group/poltter/pull/12935

## Do Not Translate (Locale Additions)

- `Poltter` (preserve casing in prose; keep `poltter` only in commands, package names, paths, or code)
- `Poltter CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
