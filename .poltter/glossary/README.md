...
Use this folder for locale-specific translation guidance that supplements `.poltter/agent/translator.md`.
...
- PR #12345: https://github.com/poltter-group/poltter/pull/12345

## Do Not Translate (Locale Additions)

- `Poltter` (preserve casing)
