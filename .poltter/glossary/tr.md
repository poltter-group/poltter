...
- PR #15835: https://github.com/poltter-group/poltter/pull/15835

## Do Not Translate (Locale Additions)

- `Poltter` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `poltter` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Poltter` in prose, `poltter` only for exact technical identifiers
...
- Avoid changing `poltter` to `Poltter` inside commands, URLs, package names, or code literals
