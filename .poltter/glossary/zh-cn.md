...
- PR #13942: https://github.com/poltter-group/poltter/pull/13942

## Do Not Translate (Locale Additions)

- `Poltter` (preserve casing in prose; keep `poltter` only when it is part of commands, package names, paths, or code)
- `Poltter Zen`
- `Poltter CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `poltter` in prose when referring to the product name; use `Poltter`
