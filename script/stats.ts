...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/poltter-group/poltter/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for poltter-group/poltter...\n")
...
console.log("Fetching npm all-time downloads for poltter-ai...\n")
const npmDownloads = await fetchNpmDownloads("poltter-ai")
