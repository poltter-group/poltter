...
Generates UPCOMING_CHANGELOG.md by running the poltter changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for poltter run (default: low)
      --quiet            Suppress poltter command output unless it fails
